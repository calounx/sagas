...
class DatabaseSchema
{
    ...
    public function createTables(): void
    {
        ...
        update_option('saga_manager_db_version', SAGA_MANAGER_VERSION);
    }
    ...
    private function getAttributeValuesTableSQL(): string
    {
        ...
        $entities_table = $this->prefix . 'entities';
        $definitions_table = $this->prefix . 'attribute_definitions';
     ...
     *
     * Called separately from createTables() because dbDelta() doesn't support
     * foreign key constraints. This method is idempotent - checks for existence
    ...
    public function addForeignKeys(): void
    {
        ...
        // Suppress errors during constraint checks
        ...
        // Add CHECK constraints to entity_relationships
    ...
    /**
     * Helper: Add foreign key if it doesn't exist
     */
    ...
    /**
     * Helper: Add CHECK constraint if it doesn't exist
     */
