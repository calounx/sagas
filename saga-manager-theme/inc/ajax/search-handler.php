...
class SearchHandler {
    ...
    private function register_hooks(): void {
        add_action('wp_ajax_saga_semantic_search', [$this, 'handle_search']);
        add_action('wp_ajax_nopriv_saga_semantic_search', [$this, 'handle_search']);

        add_action('wp_ajax_saga_autocomplete', [$this, 'handle_autocomplete']);
        add_action('wp_ajax_nopriv_saga_autocomplete', [$this, 'handle_autocomplete']);

        add_action('wp_ajax_saga_track_search_click', [$this, 'handle_track_click']);
        add_action('wp_ajax_nopriv_saga_track_search_click', [$this, 'handle_track_click']);
    }
    ...
    public function handle_track_click(): void {
        ...
        $clicks = get_transient('saga_search_clicks') ?: [];
        $clicks[] = [
            'query' => $query,
            'entity_id' => $entity_id,
            'timestamp' => time(),
    ...
    private function track_search(string $query, int $results_count): void {
        $searches = get_transient('saga_search_queries') ?: [];
        ...
        $popular = get_option('saga_popular_searches', []);
