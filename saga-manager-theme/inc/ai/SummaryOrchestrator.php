...
class SummaryOrchestrator
{
     ...
     */
    public function startSummaryGeneration(int $saga_id, SummaryType $type, array $options = []): SummaryRequest
    {
        // Extract options
        ...
        $request = new SummaryRequest(...array_merge(
    ...
    private function processRequest(SummaryRequest $request): GeneratedSummary
    {
        ...
        try {
            ...
            $summary = new GeneratedSummary(...array_merge(
    ...
    public function regenerateSummary(int $summary_id, string $reason): GeneratedSummary
    {
        ...
        $new_request = new SummaryRequest(...array_merge(
...
add_action('saga_process_summaries', function() {
