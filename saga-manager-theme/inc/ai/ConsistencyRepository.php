...
use SagaManager\AI\Interfaces\ConsistencyRepositoryInterface;
 ...
 * Implements ConsistencyRepositoryInterface for Dependency Inversion.
 */
final class ConsistencyRepository implements ConsistencyRepositoryInterface {
	...
	public function getStatistics( int $sagaId ): array {
		...
		// Convert to integers
		foreach ( array( 'total_issues', 'open_issues', 'resolved_issues', 'dismissed_issues', 'critical_count', 'high_count', 'medium_count', 'low_count' ) as $key ) {
