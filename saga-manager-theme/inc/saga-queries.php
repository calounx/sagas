 ...
 */
function saga_query_entities_by_saga(int $saga_id, array $args = []): WP_Query
{
    $default_args = [
 ...
 * @return WP_Query Query object
 */
function saga_query_entities_by_type(string $type, array $args = []): WP_Query
{
    $default_args = [
        'post_type' => 'saga_entity',
        'posts_per_page' => -1,
 ...
 * @return WP_Query Query object
 */
function saga_query_related_entities(int $post_id, array $args = []): WP_Query
{
 ...
 * @return WP_Query Query object
 */
function saga_query_recent_entities(int $count = 5, array $args = []): WP_Query
{
    $default_args = [
        'post_type' => 'saga_entity',
 ...
 * @return WP_Query Query object
 */
function saga_query_top_entities(int $count = 10, array $args = []): WP_Query
{
    $default_args = [
        'post_type' => 'saga_entity',
        'posts_per_page' => $count,
 ...
 * @return WP_Query Query object
 */
function saga_query_entities_by_importance(int $min, int $max, array $args = []): WP_Query
{
    $default_args = [
        'post_type' => 'saga_entity',
        'posts_per_page' => -1,
