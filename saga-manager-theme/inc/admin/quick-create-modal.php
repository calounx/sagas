...
$entity_types = array(
	'character' => array(
		'icon'  => 'admin-users',
		'label' => __( 'Character', 'saga-manager' ),
	),
	'location'  => array(
		'icon'  => 'location',
		'label' => __( 'Location', 'saga-manager' ),
	),
	'event'     => array(
		'icon'  => 'calendar-alt',
		'label' => __( 'Event', 'saga-manager' ),
	),
	'faction'   => array(
		'icon'  => 'groups',
		'label' => __( 'Faction', 'saga-manager' ),
	),
	'artifact'  => array(
		'icon'  => 'star-filled',
		'label' => __( 'Artifact', 'saga-manager' ),
	),
	'concept'   => array(
		'icon'  => 'lightbulb',
		'label' => __( 'Concept', 'saga-manager' ),
	),
);
?>
