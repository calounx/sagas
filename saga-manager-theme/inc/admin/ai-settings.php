...
function saga_ai_register_settings(): void {
	...
	register_setting(
		'saga_ai_settings',
		'saga_ai_enabled_rules',
		array(
			'type'              => 'array',
			'default'           => array( 'timeline', 'character', 'location', 'relationship', 'logical' ),
...
function saga_ai_sanitize_provider( string $provider ): string {
	$validProviders = array( 'openai', 'anthropic' );
...
function saga_ai_sanitize_sensitivity( string $sensitivity ): string {
	$validLevels = array( 'strict', 'moderate', 'permissive' );
...
function saga_ai_sanitize_rules( $rules ): array {
	...
	$validRules = array( 'timeline', 'character', 'location', 'relationship', 'logical' );
...
function saga_ai_render_settings_page(): void {
	...
	$enabledRules = get_option( 'saga_ai_enabled_rules', array() );
