...
function saga_align_entity_attributes(array $entities): array {
    ...
    uasort($all_attributes, function($a, $b) {
...
function saga_get_attribute_priority(string $key, string $entity_type): int {
    ...
    $type_specific = [
        'character' => ['species', 'homeworld', 'birth_year', 'gender', 'height', 'mass'],
        'location' => ['planet', 'terrain', 'climate', 'population', 'government'],
        'event' => ['date', 'location', 'participants', 'outcome'],
        'faction' => ['type', 'leader', 'headquarters', 'ideology'],
    ];
...
function saga_enqueue_comparison_assets(): void {
    ...
    wp_localize_script('saga-comparison', 'sagaComparison', [
