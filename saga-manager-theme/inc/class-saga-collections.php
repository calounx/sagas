...
class Saga_Collections {
    ...
    public function init(): void {
        add_action('wp_ajax_saga_add_to_collection', [$this, 'ajax_add_to_collection']);
        add_action('wp_ajax_nopriv_saga_add_to_collection', [$this, 'ajax_guest_response']);

        add_action('wp_ajax_saga_remove_from_collection', [$this, 'ajax_remove_from_collection']);
        add_action('wp_ajax_nopriv_saga_remove_from_collection', [$this, 'ajax_guest_response']);

        add_action('wp_ajax_saga_create_collection', [$this, 'ajax_create_collection']);
        add_action('wp_ajax_nopriv_saga_create_collection', [$this, 'ajax_guest_response']);

        add_action('wp_ajax_saga_delete_collection', [$this, 'ajax_delete_collection']);
        add_action('wp_ajax_nopriv_saga_delete_collection', [$this, 'ajax_guest_response']);

        add_action('wp_ajax_saga_rename_collection', [$this, 'ajax_rename_collection']);
        add_action('wp_ajax_nopriv_saga_rename_collection', [$this, 'ajax_guest_response']);

        add_action('wp_ajax_saga_get_collections', [$this, 'ajax_get_collections']);
        add_action('wp_ajax_nopriv_saga_get_collections', [$this, 'ajax_guest_response']);
    }
    ...
    public function create_collection(int $user_id, string $collection_name): array|WP_Error {
        ...
        if (count($collections) >= self::MAX_COLLECTIONS) {
            return new WP_Error('max_collections', sprintf(
    ...
    public function add_to_collection(int $user_id, string $collection_slug, int $entity_id): bool|WP_Error {
        ...
        if (count($entity_ids) >= self::MAX_ENTITIES_PER_COLLECTION) {
            return new WP_Error('max_entities', sprintf(
