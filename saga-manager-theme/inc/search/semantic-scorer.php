...
class SemanticScorer {
	 ...
	 */
	private array $synonyms = array(
		'battle'    => array( 'fight', 'combat', 'war', 'conflict', 'engagement' ),
		'character' => array( 'person', 'individual', 'protagonist', 'hero', 'figure' ),
		'location'  => array( 'place', 'area', 'region', 'site', 'locale' ),
		'event'     => array( 'occurrence', 'incident', 'happening', 'episode' ),
		'faction'   => array( 'group', 'organization', 'alliance', 'coalition', 'party' ),
		'artifact'  => array( 'item', 'object', 'relic', 'treasure' ),
		'power'     => array( 'ability', 'skill', 'capability', 'force' ),
		'ancient'   => array( 'old', 'historic', 'primordial', 'archaic' ),
		'leader'    => array( 'commander', 'chief', 'ruler', 'head', 'captain' ),
		'dark'      => array( 'evil', 'sinister', 'malevolent', 'wicked' ),
		'light'     => array( 'good', 'righteous', 'benevolent', 'pure' ),
	);
	...
	private function stem( string $word ): string {
		$suffixes = array( 'ing', 'ed', 'es', 's', 'ly', 'er', 'est' );
